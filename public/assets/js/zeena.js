(function ($) {
  ...
  function thmOwlInit() {
    ...
    try {
      ...
      console.error("Error initializing thm-owl__carousel: ", error);
  ...
  $form.validate({
    ...
    submitHandler: function (form) {
      // Use event.preventDefault() via jQuery's .on('submit')
      // But since we're in submitHandler, we just handle AJAX here

      // Optional: Show loading message
      $(form).find(".result").html("<div class='alert alert-info' role='alert'> Sending... </div>");
      ...
      $.post(
        ...
        $(form).find(".result").html("<div class='alert alert-info' role='alert'> Something went wrong. Please try again. </div>");
      });
  ...
  // OPTIONAL: Safety net in case form submits outside validation
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    tabs.forEach(tab => {
        tab.addEventListener('click', function() {
            // Get the target pane ID from the data-tab attribute
